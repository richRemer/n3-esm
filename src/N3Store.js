...
export default class N3Store {
  ...
  *readQuads(subject, predicate, object, graph) {
  ...
  match(subject, predicate, object, graph) {
    return new DatasetCore(this, subject, predicate, object, graph);
  }
...
/**
 * A class that implements DatasetCore interface.
 */
class DatasetCore {
  ...
  match(subject, predicate, object, graph) {
    return new DatasetCore(this.filtered, subject, predicate, object, graph);
  }
